...
class PlantControllerTest {
    ...
    @Test
    void itShouldSavePlant() throws Exception {
        Plant plant = Plant.builder()
                .sequenceNumber(1)
                .plantName("test")
                .build();

        given(plantService.addNewPlant(plant)).willReturn(plant);
...
//                .accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.sequenceNumber").exists());
